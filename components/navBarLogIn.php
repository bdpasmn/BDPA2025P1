    ...
    <div class="flex justify-between items-center h-20 w-full">
      ...
      <div class="flex flex-row items-center space-x-6">
        ...
        <div class="flex space-x-2">
          <a href="/pages/dashboard/dashboard.php" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded custom-shadow text-sm font-medium">
            Dashboard
          </a>
          <a href="/pages/mail/mail.php" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded custom-shadow text-sm font-medium">
            Mail
          </a>
          <a href="/pages/buffet/buffet.php" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded custom-shadow text-sm font-medium">
            Buffet
          </a>
          <a href="index.php" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded custom-shadow text-sm font-medium">
            Log Out
          </a>
        </div>
      </div>
      ...
      <!-- Center: Points & Level -->
      <div class="flex flex-col text-center text-yellow-300 text-sm font-semibold">
